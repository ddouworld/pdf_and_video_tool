...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_7.setGeometry(QtCore.QRect(190, 130, 151, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_7.setText(_translate("MainWindow", "从第多少秒开始添加或删除"))
        self.video_water_label_2.setText(_translate("MainWindow", "将水印文件或者广告视频文件拖动到此处"))
